...
class ModuleEntitiesApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> deletePersonalizeModuleModulePersonalizeDeleteDelete({ 
    JsonObject? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/module/personalize/delete';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updatePersonalizeModuleModulePersonalizeCreateOrUpdatePut({ 
    JsonObject? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/module/personalize/create_or_update';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
