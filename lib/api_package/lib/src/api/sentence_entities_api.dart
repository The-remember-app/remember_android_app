...
class SentenceEntitiesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SentenceDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SentenceDTO>> createTermSentenceCreatePost({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getAllTermSentenceAllGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [SentenceDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SentenceDTO>> getOneTermSentenceSentenceIdGet({ 
