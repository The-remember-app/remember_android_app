...
class DefaultApi {
  ...
  Future<Response<JsonObject>> createFolderFolderCreateAsTreePost({ 
    JsonObject? body,
  ...
  Future<Response<ModuleDTO>> createModuleModuleCreatePost({ 
    ...
    ModuleDTO? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ModuleDTO),
      ) as ModuleDTO;
  ...
  Future<Response<TermDTO>> createTermTermCreatePost({ 
    ...
    TermDTO? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TermDTO),
      ) as TermDTO;
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getAllFoldersFolderAllAsTreeGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FolderWithNestedEntitiesDTO>> getOneFolderFolderFolderIdAsTreeGet({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FolderWithRootEntityDTO>> getOneFolderFolderFolderIdWithParentGet({ 
    required JsonObject folderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<PersonalizeModuleDTO>> getOneModuleModuleModuleIdGet({ 
    ...
    PersonalizeModuleDTO? _responseData;
    ...
    return Response<PersonalizeModuleDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PersonalizeTermDTO>> getOneTermTermTermIdGet({ 
    ...
    PersonalizeTermDTO? _responseData;
    ...
    return Response<PersonalizeTermDTO>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
